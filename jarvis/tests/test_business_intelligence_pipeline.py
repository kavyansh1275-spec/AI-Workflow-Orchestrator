...
class TestBusinessIntelligencePipeline(unittest.TestCase):
    def test_analyze(self):
        r=BusinessIntelligencePipeline().analyze(10000,6000,40,100,50,20,10,[{"revenue":10},{"revenue":11},{"revenue":9},{"revenue":100}])
        self.assertEqual(r.kpis.profit,4000); self.assertIsNotNone(r.funnel); self.assertTrue(r.anomalies)
